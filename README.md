...
## 📋 Table of ContentsLanding Page

![SamKit Logo](client/public/figmaAssets/logos/cropped-Untitled-design-4-32x32.png)
...
- **Development Tools**: Hot-reload and development utilities included
...
- **Network**: `http://[your-ip-address]:[PORT]`
...
- Restart server: `npm restart` or `yarn restart`
