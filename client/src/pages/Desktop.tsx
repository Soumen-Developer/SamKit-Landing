...
export const Desktop = (): JSX.Element => {
  return (
    <div className="bg-gray-50 dark:bg-black text-gray-900 dark:text-white min-h-screen w-full overflow-x-hidden">
      <div className="fixed inset-0 overflow-hidden pointer-events-none -z-10">
        <div className="absolute top-[10%] left-[-10%] bg-gradient-to-b from-[#015687] to-[#015687] w-[600px] h-[600px] rounded-full blur-[200px] opacity-30 dark:opacity-50" />
        <div className="absolute top-[30%] right-[-5%] bg-gradient-to-b from-[#00a2b4] to-[#4b004e] w-[600px] h-[600px] rounded-full blur-[200px] opacity-30 dark:opacity-50" />
        <div className="absolute top-[60%] left-[5%] bg-gradient-to-b from-[#00a2b4] to-[#4b004e] w-[600px] h-[600px] rounded-full blur-[200px] opacity-30 dark:opacity-50" />
        <div className="absolute bottom-[10%] right-[10%] bg-gradient-to-b from-[#00a2b4] to-[#4b004e] w-[600px] h-[600px] rounded-full blur-[200px] opacity-30 dark:opacity-50" />
      </div>

      <header className="sticky top-0 z-50 w-full backdrop-blur-sm bg-white/90 dark:bg-black/50 border-b border-gray-200 dark:border-[#025ca5]/20">
      ...
      <section className="relative py-12 lg:py-24">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-6xl mx-auto text-center space-y-6">
            <h1 className="font-semibold text-4xl sm:text-5xl lg:text-7xl xl:text-8xl leading-tight text-gray-900 dark:text-white">
              Fusion App for
              <br />
              Faster Audits
            </h1>
            <p className="text-lg sm:text-xl lg:text-2xl max-w-4xl mx-auto leading-relaxed text-gray-700 dark:text-white/90">
      ...
      <section className="py-12 lg:py-20 relative">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            <Card className="bg-white dark:bg-[#0c0a01] rounded-[15px] shadow-lg border border-gray-200 dark:border-0" data-testid="card-solution-finance">
              <CardContent className="p-6 lg:p-8">
                ...
                <div className="space-y-3 text-gray-700 dark:text-[#dff1fd] text-sm lg:text-base">
            ...
            <Card className="bg-white dark:bg-black rounded-[15px] shadow-lg border border-gray-200 dark:border-0" data-testid="card-solution-security">
              <CardContent className="p-6 lg:p-8">
                <img
            ...
            <Card className="bg-white dark:bg-[#0c0a01] rounded-[15px] shadow-lg border border-gray-200 dark:border-0" data-testid="card-solution-devops">
              <CardContent className="p-6 lg:p-8">
                <img
                  className="w-16 h-16 lg:w-20 lg:h-20 mb-4"
                  alt="DevOps icon"
      ...
      <section className="py-12 lg:py-20 bg-gradient-to-b from-transparent to-gray-100 dark:to-black/20">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="bg-white/60 dark:bg-[#ffffff03] rounded-[40px] p-6 lg:p-12 backdrop-blur-sm border border-gray-200 dark:border-white/10 shadow-xl">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-8">
              {statsData.map((stat, index) => (
                ...
                >
                  <div className="font-bold text-gray-900 dark:text-white text-4xl lg:text-5xl xl:text-6xl">
                    {stat.value}
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {blogData.map((blog, index) => (
              <div key={index} className="space-y-4" data-testid={`blog-${index}`}>
                ...
                <Button className="bg-[#015687] hover:bg-[#014570] dark:bg-white dark:hover:bg-gray-100 text-white dark:text-black rounded-[10px] border border-[#4e8dc0] px-6 py-2.5" data-testid={`button-blog-${index}`}>
                  Read More
                </Button>
              </div>
            ))}
      ...
      <section className="py-12 lg:py-20 bg-gradient-to-b from-transparent to-gray-100 dark:to-[#015687]/10">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="bg-[#015687] dark:bg-[#015687] rounded-[20px] p-8 lg:p-12">
